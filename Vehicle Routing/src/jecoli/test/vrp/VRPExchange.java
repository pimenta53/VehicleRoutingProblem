...
public class VRPExchange implements IReproductionOperator<PermutationRepresentation,PermutationRepresentationFactory>{
	 ...
	 */
	public VRPExchange(VRP problemInstance){
			...
			PermutationRepresentation childGenome) 
	{
		...
		int [][] res = problemInstance.get_routes(genomeArray);
		 ...
		 first_imp_string_exchange (res, 2);
		 //best_imp_string_exchange (res, 2);
